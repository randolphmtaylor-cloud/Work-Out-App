...
export const MOCK_EQUIPMENT: Equipment[] = [
  ...
  { id: "eq-13", name: "Barbell", canonical_name: "barbell", aliases: ["bar"], category: "free_weight", created_at: "2024-01-01T00:00:00Z" },
  { id: "eq-14", name: "Shoulder Press Machine", canonical_name: "shoulder-press-machine", aliases: ["machine shoulder press"], category: "machine", created_at: "2024-01-01T00:00:00Z" },
  { id: "eq-15", name: "Iso-Lateral Leg Press Machine", canonical_name: "iso-lateral-leg-press-machine", aliases: ["iso leg press"], category: "machine", created_at: "2024-01-01T00:00:00Z" },
  { id: "eq-16", name: "Legend Fitness Lateral Raise Machine", canonical_name: "legend-fitness-lateral-raise-machine", aliases: ["machine lateral raise"], category: "machine", created_at: "2024-01-01T00:00:00Z" },
];
...
export const MOCK_EXERCISES: Exercise[] = [
  ...
  { id: "ex-11", name: "Trap Bar Deadlift",             canonical_name: "trap-bar-deadlift",             aliases: ["hex bar deadlift"],        equipment_id: "eq-8",  muscle_groups: ["glutes","hamstrings","quads"],        tags: ["legs","lower","compound"], created_at: "2024-01-01T00:00:00Z" },
  ...
  { id: "ex-18", name: "Seated Row", canonical_name: "seated-row", aliases: ["seated rows","seated cable row","seated row - mag","machine row"], equipment_id: "eq-6", muscle_groups: ["back","shoulders","biceps"], tags: ["pull","upper","compound"], primary_category: "back", primary_muscles: ["back"], secondary_muscles: ["shoulders","biceps"], movement_pattern: "horizontal pull", exercise_type: "compound", environments: ["gym"], laterality: "bilateral", tracking_type: "weight_reps", difficulty: "beginner", created_at: "2024-01-01T00:00:00Z" },
  ...
  { id: "ex-zercher-squat", name: "Zercher Squat", canonical_name: "zercher-squat", aliases: ["zercher squats","xertcher squat"], equipment_id: "eq-13", muscle_groups: ["quads","glutes","hamstrings","back","core"], tags: ["legs","lower","compound"], primary_category: "legs", primary_muscles: ["quads","glutes"], secondary_muscles: ["hamstrings","back","core"], movement_pattern: "squat", exercise_type: "compound", environments: ["gym"], laterality: "bilateral", tracking_type: "weight_reps", difficulty: "advanced", cautions: ["Maintain a braced trunk and secure bar position in the elbow crease."], created_at: "2024-01-01T00:00:00Z" },
  { id: "ex-machine-shoulder-press", name: "Machine Shoulder Press", canonical_name: "machine-shoulder-press", aliases: ["shoulder press machine"], equipment_id: "eq-14", muscle_groups: ["shoulders","triceps"], tags: ["push","upper","compound"], primary_category: "shoulders", primary_muscles: ["shoulders"], secondary_muscles: ["triceps"], movement_pattern: "vertical push", exercise_type: "compound", environments: ["gym"], laterality: "bilateral", tracking_type: "weight_reps", difficulty: "beginner", created_at: "2024-01-01T00:00:00Z" },
  { id: "ex-iso-lateral-leg-press", name: "Iso-Lateral Leg Press", canonical_name: "iso-lateral-leg-press", aliases: ["iso leg press","iso-lateral leg press"], equipment_id: "eq-15", muscle_groups: ["quads","glutes","hamstrings"], tags: ["legs","lower","compound"], primary_category: "legs", primary_muscles: ["quads","glutes"], secondary_muscles: ["hamstrings"], movement_pattern: "knee-dominant push", exercise_type: "compound", environments: ["gym"], laterality: "bilateral", tracking_type: "weight_reps", difficulty: "beginner", created_at: "2024-01-01T00:00:00Z" },
  { id: "ex-legend-fitness-lateral-raise", name: "Legend Fitness Lateral Raise", canonical_name: "legend-fitness-lateral-raise", aliases: ["legend deltoid raise","machine lateral raise"], equipment_id: "eq-16", muscle_groups: ["shoulders"], tags: ["push","upper","isolation"], primary_category: "shoulders", primary_muscles: ["shoulders"], movement_pattern: "shoulder abduction", exercise_type: "isolation", environments: ["gym"], laterality: "bilateral", tracking_type: "weight_reps", difficulty: "beginner", created_at: "2024-01-01T00:00:00Z" },
  ...
  { id: "goal-abs-plank", name: "Plank", canonical_name: "plank", aliases: ["forearm plank"], muscle_groups: ["core"], tags: ["core", "isolation"], primary_category: "core", primary_muscles: ["core"], movement_pattern: "anti-extension", exercise_type: "isolation", environments: ["home", "gym"], laterality: "timed", tracking_type: "duration", difficulty: "beginner", created_at: "2024-01-01T00:00:00Z" },
